...
<style>
  .sidebar {
    ...
    background: var(--sidebar, var(--color-bg-sidebar));
    border-right: 1px solid var(--border, var(--color-border-primary));
  ...
  .search-clear:hover { color: var(--text-muted, var(--color-text-secondary)); }
